...
import { createHaendler, HaendlerActionState } from './haendlerActions';
...
const initialState: HaendlerActionState = {
  message: '',
  type: 'idle',
  errors: null,
};
...
function SubmitButton() {
  ...
  return (
    <Button type="submit" disabled={pending} className="w-full md:w-auto">
      {pending ? 'Wird erstellt...' : 'Händler erstellen'}
    </Button>
  );
}

export function CreateHaendlerForm() {
  const [state, formAction] = useFormState(createHaendler, initialState);
