...
export const PlatformSection = () => {
  return (
    <section className="py-16 sm:py-24 bg-gray-50/50 dark:bg-background">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-primary font-semibold uppercase tracking-wider">Für Profis & Enthusiasten</p>
          <h2 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl">Die zentrale Plattform für Fahrzeugfolierung</h2>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white dark:bg-background p-8 rounded-xl shadow-md border border-gray-200 dark:border-gray-700">
            <h3 className="text-xl font-bold text-gray-900 dark:text-white">Für DIY-Enthusiasten</h3>
          ...
          <div className="bg-white dark:bg-background p-8 rounded-xl shadow-md border border-gray-200 dark:border-gray-700">
            <h3 className="text-xl font-bold text-gray-900 dark:text-white">Für Profis</h3>
            <ul className="mt-6 space-y-4">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => (
            <div key={index} className="bg-white dark:bg-background p-8 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 text-center">
